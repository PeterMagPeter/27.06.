...
import { Badge, Modal, Toast, ToastBody, ToastHeader } from "react-bootstrap";
/**
 *
    ...
    <>
      ...
      <div className={styles.profilePage}>
        ...
        <div className={styles.profileDiv}>
          {!skinSetting ? (
            <>
              <div className={styles.profilePicDiv2}>
                <Badge
                  bg="warning"
                  text="dark"
                  className={styles.profilePicBadge}
                >
                  Coming soon
                </Badge>
                <br />
              ...
              <hr />
              <label className={styles.profileText}>
                <b>E-mail: </b>
                {user.email}
              </label>
              <br />
